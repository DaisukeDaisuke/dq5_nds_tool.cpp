...
const uint64_t a_powers[100] = {
    1566083941, 2203506137, 1324822941, 1986974193, 2643373845, 1922267721, 3584877005,
...
const uint64_t c_sums[100] = {
    2531011, 1906254514, 3539334397, 3878528404, 2901429799, 3184304422, 812766401, 720132584,
...
int main() {
    int list1[5] = {47,14,38,39,12};
    int list4[5] = {51,18,1,23,22};
